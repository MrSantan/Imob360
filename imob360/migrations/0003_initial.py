...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('imob360', '0002_remove_propertyimage_property_delete_property_and_more'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('property', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='images', to='imob360.property')),
            ],
            options={
